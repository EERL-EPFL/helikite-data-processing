...
class Instrument(ABC):
    ...
    def get_expected_columns_level0(self, is_reference: bool, with_dtype: bool = False) -> list[str] | dict[str, str]:
        ...
        expected_columns = {f"{self.name}_{column}": str(t) for column, t in df.dtypes.to_dict().items()}
